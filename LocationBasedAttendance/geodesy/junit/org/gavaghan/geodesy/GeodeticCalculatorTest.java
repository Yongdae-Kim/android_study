package junit.org.gavaghan.geodesy;

import junit.framework.TestCase;
import src.org.gavaghan.geodesy.Ellipsoid;
import src.org.gavaghan.geodesy.GeodeticCalculator;
import src.org.gavaghan.geodesy.GeodeticCurve;
import src.org.gavaghan.geodesy.GeodeticMeasurement;
import src.org.gavaghan.geodesy.GlobalCoordinates;
import src.org.gavaghan.geodesy.GlobalPosition;
...
public class GeodeticCalculatorTest extends TestCase {
	...
	public void testCalculateGeodeticMeasurement() {
		...
		assertEquals(1521788.826, geoMeasurement.getPointToPointDistance(),
				0.001);
		assertEquals(1521782.748, geoMeasurement.getEllipsoidalDistance(),
				0.001);
	...
	public void testAntiPodal1() {
		...
		assertEquals(19970718.422432076, geoCurve.getEllipsoidalDistance(),
				0.001);
	...
	public void testAntiPodal2() {
		...
		assertEquals(19893320.272061437, geoCurve.getEllipsoidalDistance(),
				0.001);
	...
	public void testInverseWithDirect() {
		...
		dest = geoCalc.calculateEndingGlobalCoordinates(reference,
	...
	public void testPoleCrossing() {
		...
		GlobalCoordinates dest = geoCalc.calculateEndingGlobalCoordinates(
				reference, lincolnMemorial, startBearing, distance);
