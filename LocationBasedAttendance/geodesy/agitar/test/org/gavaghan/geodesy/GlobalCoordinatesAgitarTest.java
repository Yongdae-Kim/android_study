...
public class GlobalCoordinatesAgitarTest extends AgitarTestCase {
	...
	public void testConstructor() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(
				-90.000000009, 0.0);
		assertEquals("globalCoordinates.getLongitude()", 180.0,
				globalCoordinates.getLongitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLatitude()", -89.999999991,
				globalCoordinates.getLatitude(), 1.0E-6);
	}

	public void testConstructor1() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(90.0,
				-180.001);
		assertEquals("globalCoordinates.getLongitude()", 179.99900000000002,
				globalCoordinates.getLongitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLatitude()", 90.0,
				globalCoordinates.getLatitude(), 1.0E-6);
	}
	...
	public void testConstructor2() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(90.0,
				-179.999);
		assertEquals("globalCoordinates.getLongitude()", -179.999,
				globalCoordinates.getLongitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLatitude()", 90.0,
				globalCoordinates.getLatitude(), 1.0E-6);
	}
	...
	public void testConstructor3() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(-450.0009,
				360.001);
		assertEquals("globalCoordinates.getLongitude()", -179.99900000000002,
				globalCoordinates.getLongitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLatitude()", -89.9991,
				globalCoordinates.getLatitude(), 1.0E-6);
	}

	public void testConstructor4() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(-1169.9991,
				-179.999);
		assertEquals("globalCoordinates.getLongitude()", -179.999,
				globalCoordinates.getLongitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLatitude()", -89.9991,
	...
	public void testConstructor6() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(180.001,
				360.001);
		assertEquals("globalCoordinates.getLongitude()", -179.99900000000002,
				globalCoordinates.getLongitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLatitude()", -9.999999999763531E-4,
				globalCoordinates.getLatitude(), 1.0E-6);
	}
	...
	public void testConstructor7() throws Throwable {
		...
		assertEquals("globalCoordinates.getLongitude()", 180.0,
				globalCoordinates.getLongitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLatitude()", 0.0,
				globalCoordinates.getLatitude(), 1.0E-6);
	}

	public void testConstructor8() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(90.0009,
				360.001);
		assertEquals("globalCoordinates.getLongitude()", -179.99900000000002,
				globalCoordinates.getLongitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLatitude()", 89.9991,
	...
	public void testConstructor9() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(-90.0009,
				100.0);
		assertEquals("globalCoordinates.getLongitude()", -80.0,
				globalCoordinates.getLongitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLatitude()", -89.9991,
				globalCoordinates.getLatitude(), 1.0E-6);
	}
	...
	public void testConstructor11() throws Throwable {
		...
		assertEquals("globalCoordinates.getLongitude()", 180.0,
				globalCoordinates.getLongitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLatitude()", 80.0,
				globalCoordinates.getLatitude(), 1.0E-6);
	}

	public void testConstructor12() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(
				-90.000000009, 360.001);
		assertEquals("globalCoordinates.getLongitude()", -179.99900000000002,
				globalCoordinates.getLongitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLatitude()", -89.999999991,
				globalCoordinates.getLatitude(), 1.0E-6);
	...
	public void testConstructor13() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(-180.001,
				-360.0036);
		assertEquals("globalCoordinates.getLongitude()", 179.9964,
				globalCoordinates.getLongitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLatitude()", 9.999999999763531E-4,
				globalCoordinates.getLatitude(), 1.0E-6);
	}
	...
	public void testConstructor14() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(-181.0,
				360.001);
		assertEquals("globalCoordinates.getLongitude()", -179.99900000000002,
				globalCoordinates.getLongitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLatitude()", 1.0,
				globalCoordinates.getLatitude(), 1.0E-6);
	}

	public void testConstructor15() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(-269.9991,
				360.001);
		assertEquals("globalCoordinates.getLongitude()", -179.99900000000002,
				globalCoordinates.getLongitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLatitude()", 89.9991,
	...
	public void testConstructor16() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(89.999,
				-180.001);
		assertEquals("globalCoordinates.getLongitude()", 179.99900000000002,
				globalCoordinates.getLongitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLatitude()", 89.99900000000002,
				globalCoordinates.getLatitude(), 1.0E-6);
	}
	...
	public void testCanonicalize() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(90.0009,
				100.0);
		callPrivateMethod("org.gavaghan.geodesy.GlobalCoordinates",
				"canonicalize", new Class[] {}, globalCoordinates,
				new Object[] {});
		assertEquals("globalCoordinates.getLongitude()", -80.0,
				globalCoordinates.getLongitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLatitude()", 89.9991,
	...
	public void testCanonicalize1() throws Throwable {
		...
		callPrivateMethod("org.gavaghan.geodesy.GlobalCoordinates",
				"canonicalize", new Class[] {}, globalCoordinates,
				new Object[] {});
		assertEquals("globalCoordinates.getLongitude()", 100.0,
				globalCoordinates.getLongitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLatitude()", 90.0,
				globalCoordinates.getLatitude(), 1.0E-6);
	}
	...
	public void testCompareTo() throws Throwable {
		...
		int result = globalCoordinates
				.compareTo(new GlobalCoordinates(0.0, 0.0));
		assertEquals("result", -1, result);
	}

	public void testCompareTo1() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(
				-54.12682626557432, -43.319025743636864);
		int result = new GlobalCoordinates(-54.12682626557432,
				-43.31902574363687).compareTo(globalCoordinates);
		assertEquals("result", 0, result);
	}

	public void testCompareTo2() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(0.0, -69.0);
		int result = globalCoordinates.compareTo(new GlobalCoordinates(-1.0,
				-69.0));
		assertEquals("result", 1, result);
	}

	public void testCompareTo3() throws Throwable {
		int result = new GlobalCoordinates(0.0, -28.367958936972176)
				.compareTo(new GlobalCoordinates(1000.0, -28.36739158630371));
		assertEquals("result", -1, result);
	}
	...
	public void testCompareTo5() throws Throwable {
		...
		int result = new GlobalCoordinates(-270.0, -9.999999999763531E-4)
				.compareTo(other);
		assertEquals("result", 1, result);
	}
	...
	public void testEquals() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(1000.0, 0.0);
		boolean result = globalCoordinates.equals(new GlobalCoordinates(0.0,
				360.001));
	...
	public void testEquals3() throws Throwable {
		boolean result = new GlobalCoordinates(100.0, 1000.0)
				.equals("testString");
		assertFalse("result", result);
	}
	...
	public void testSetLatitude3() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(1000.0,
				180.0);
		globalCoordinates.setLatitude(-360.0);
		assertEquals("globalCoordinates.getLatitude()", 0.0,
				globalCoordinates.getLatitude(), 1.0E-6);
	...
	public void testSetLatitude4() throws Throwable {
		...
		assertEquals("globalCoordinates.getLatitude()", -89.999,
				globalCoordinates.getLatitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLongitude()", 100.0,
				globalCoordinates.getLongitude(), 1.0E-6);
	}
	...
	public void testSetLatitude10() throws Throwable {
		GlobalCoordinates globalPosition = new GlobalPosition(
				new GlobalCoordinates(100.0, 1000.0), 100.0);
		globalPosition.setLatitude(-90.0009);
		assertEquals("(GlobalPosition) globalPosition.getLongitude()", -80.0,
				globalPosition.getLongitude(), 1.0E-6);
		assertEquals("(GlobalPosition) globalPosition.getLatitude()", -89.9991,
				globalPosition.getLatitude(), 1.0E-6);
	}
	...
	public void testSetLongitude() throws Throwable {
		...
		assertEquals("globalCoordinates.getLongitude()", 0.025200000000040745,
				globalCoordinates.getLongitude(), 1.0E-6);
		assertEquals("globalCoordinates.getLatitude()", -90.0,
				globalCoordinates.getLatitude(), 1.0E-6);
	}
	...
	public void testSetLongitude1() throws Throwable {
		GlobalCoordinates globalCoordinates = new GlobalCoordinates(-270.0,
				100.0);
		globalCoordinates.setLongitude(-2519.9748);
		assertEquals("globalCoordinates.getLongitude()", 0.025200000000040745,
				globalCoordinates.getLongitude(), 1.0E-6);
	...
	public void testSetLongitude2() throws Throwable {
		...
		assertEquals("(GlobalPosition) globalPosition.getLongitude()", 100.0,
				globalPosition.getLongitude(), 1.0E-6);
		assertEquals("(GlobalPosition) globalPosition.getLatitude()",
				89.99900000000002, globalPosition.getLatitude(), 1.0E-6);
	}
	...
	public void testToString4() throws Throwable {
		...
		assertEquals("result", "9.999999999763531E-4N;0.0010000000000047748E;",
				result);
	}

	public void testToString5() throws Throwable {
		String result = new GlobalCoordinates(1.0, -9.999999999763531E-4)
				.toString();
		assertEquals("result", "1.0N;9.999999999763531E-4W;", result);
	}

	public void testToString6() throws Throwable {
		String result = new GlobalCoordinates(1000.0, -9.999999999763531E-4)
				.toString();
	...
	public void testCompareToThrowsNullPointerException() throws Throwable {
		try {
			new GlobalCoordinates(100.0, 1000.0)
					.compareTo((GlobalCoordinates) null);
