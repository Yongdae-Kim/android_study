...
public class EllipsoidAgitarTest extends AgitarTestCase {
	...
	public void testConstructor() throws Throwable {
		Ellipsoid ellipsoid = (Ellipsoid) callPrivateMethod(
				...
				new Class[] { double.class, double.class, double.class,
						...
						new Double(1000.0), new Double(0.0), new Double(-1.0) });
		assertEquals("ellipsoid.getSemiMajorAxis()", 100.0,
				ellipsoid.getSemiMajorAxis(), 1.0E-6);
		assertEquals("ellipsoid.getFlattening()", 0.0,
				ellipsoid.getFlattening(), 1.0E-6);
		assertEquals("ellipsoid.getSemiMinorAxis()", 1000.0,
				ellipsoid.getSemiMinorAxis(), 1.0E-6);
		assertEquals("ellipsoid.getInverseFlattening()", -1.0,
				ellipsoid.getInverseFlattening(), 1.0E-6);
	}

	public void testFromAAndF() throws Throwable {
		Ellipsoid result = Ellipsoid.fromAAndF(100.0, 1000.0);
		assertEquals("result.getFlattening()", 1000.0, result.getFlattening(),
				1.0E-6);
	}

	public void testFromAAndInverseF() throws Throwable {
		Ellipsoid result = Ellipsoid.fromAAndInverseF(100.0, 1000.0);
		assertEquals("result.getFlattening()", 0.0010, result.getFlattening(),
				1.0E-6);
	}
	...
	public void testGetSemiMinorAxis() throws Throwable {
		Ellipsoid ellipsoid = (Ellipsoid) callPrivateMethod(
				...
				new Class[] { double.class, double.class, double.class,
						double.class }, null, new Object[] { new Double(100.0),
						new Double(0.0), new Double(1000.0), new Double(-1.0) });
